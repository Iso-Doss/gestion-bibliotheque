                            ...
                            <table class="table table-head-fixed text-nowrap">
                                ...
                                foreach ($liste_auteurs as $auteur) {
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="?requette=modifier-auteur&num-auteur=<?= $auteur["num_aut"]; ?>"
                                               class="btn btn-warning">Modifier</a>
                                            <a href="#" class="btn btn-danger" data-toggle="modal"
                                               data-target="#supprimer-auteur-<?= $auteur["num_aut"]; ?>">Supprimer</a>
                                        </td>
                                    </tr>
                                    <div class="modal fade" id="supprimer-auteur-<?= $auteur["num_aut"]; ?>"
                                         style="display: none;" aria-hidden="true">
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h4 class="modal-title">Supprimer
                                                        l'auteur <?= $auteur["nom_aut"]; ?></h4>
                                                ...
                                                <div class="modal-body">
                                                    <p>Etes vous sur de vouloir supprimer
                                                        l'auteur <?= $auteur["nom_aut"]; ?> ?</p>
                                                </div>
                                                <div class="modal-footer ">

                                                    <a href="?requette=supprimer-auteur&num-auteur=<?= $auteur["num_aut"]; ?>"
